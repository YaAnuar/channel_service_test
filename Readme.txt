# Сначала делаем миграцию базы данных, убедитесь что таблицы order_table в базе данных нет
...
host    all             all             0.0.0.0/0            md5
    ...
    # я разрешаю доступ всем устройствам , так что это не очень безопасно, после работы с приложением
    # уберите.
...
2. Запуск исходников без доккера
    # Устанавливаем зависимости python
    pip install requirements.txt
    # Устанавливаем свой chat_id в 15 строке curr_conv/Config.py - chat_id получаем у бота @getmyid_bot
    # Запускаем
    # python run.py
...
3. Можете собрать доккер образы
